...
(function ($) {
    "use strict";
    console.log("大家好，我是小胡(#^.^#)，我是一枚web攻城狮，欢迎阅读我的简历(*^▽^*)");
    ...
    function initMap() {
        ...
        function createMap() {
            ...
            map.centerAndZoom(new BMap.Point(106.57728, 29.494665), 15);
        }
    ...
    $(document).on('ready', function () {
        ...
        $(".xh-menu").on('click', function () {
            if ($(".xh-leftbar").hasClass("active")) {
                $(".xh-leftbar").removeClass("active");
            } else {
                $(".xh-leftbar").addClass("active");
            }
        });
        ...
        /******************** CONTACT FORM ********************/
        $('#contact-form input,#contact-form textarea,#contact-form button').on('click', function () {
            window.open('http://mail.qq.com/cgi-bin/qm_share?t=qm_mailme&email=kfP_87_oo6PR4OC-8v78');
            return false;
        })
